...
function w(o, t, e, i) {
  o.style.transform = b(t, e, i);
}
const Q = "cubic-bezier(.4,0,.22,1)";
function H(o, t, e, i) {
  o.style.transition = t ? `${t} ${e}ms ${i || Q}` : "none";
}
function T(o, t, e) {
...
function G(o, t, e, i) {
  return {
    x: t.x - I("left", o, t, e, i) - I("right", o, t, e, i),
    y: t.y - I("top", o, t, e, i) - I("bottom", o, t, e, i)
  };
}
class nt {
  /**
  ...
  _updateAxis(t) {
    const {
      pswp: e
    } = this.slide, i = this.slide[t === "x" ? "width" : "height"] * this.currZoomLevel, n = I(t === "x" ? "left" : "top", e.options, e.viewportSize, this.slide.data, this.slide.index), r = this.slide.panAreaSize[t];
...
class ot {
  ...
  constructor(t, e, i) {
    this.data = t, this.index = e, this.pswp = i, this.isActive = e === i.currIndex, this.currentResolution = 0, this.panAreaSize = {
      ...
      x: 0,
      y: 0
    }, this.isFirstSlide = this.isActive && !i.opener.isOpen, this.zoomLevels = new q(i.options, t, e, i), this.pswp.dispatch("gettingData", {
      slide: this,
      data: this.data,
      index: e
    }), this.content = this.pswp.contentLoader.getContentBySlide(this), this.container = f("pswp__zoom-wrap", "div"), this.holderElement = null, this.currZoomLevel = 1, this.width = this.content.width, this.height = this.content.height, this.heavyAppended = !1, this.bounds = new nt(this), this.prevDisplayedWidth = -1, this.prevDisplayedHeight = -1, this.pswp.dispatch("slideInit", {
      slide: this
    });
  }
  /**
  ...
  zoomTo(t, e, i, s) {
    ...
    s || (t = A(t, this.zoomLevels.min, this.zoomLevels.max)), this.setZoomLevel(t), this.pan.x = this.calculateZoomToPanOffset("x", e, r), this.pan.y = this.calculateZoomToPanOffset("y", e, r), W(this.pan);
    const a = () => {
  ...
  calculateSize() {
    ...
    p(this.panAreaSize, G(t.options, t.viewportSize, this.data, this.index)), this.zoomLevels.update(this.width, this.height, this.panAreaSize), t.dispatch("calcSlideSize", {
      slide: this
    });
  }
  /** @returns {string} */
...
const rt = 0.35, at = 0.6, M = 0.4, F = 0.5;
function ht(o, t) {
  return o * t / (1 - t);
}
class lt {
  ...
  change() {
    ...
    if (i === "y" && this.pswp.options.closeOnVerticalDrag && s && s.currZoomLevel <= s.zoomLevels.fit && !this.gestures.isMultitouch) {
      ...
      if (!this.pswp.dispatch("verticalDrag", {
        ...
        this._setPanWithFriction("y", n, at);
        const r = 1 - Math.abs(this._getVerticalDragRatio(s.pan.y));
        this.pswp.applyBgOpacity(r), s.applyCurrentZoomPan();
      }
    } else
      this._panOrMoveMainScroll("x") || (this._panOrMoveMainScroll("y"), s && (W(s.pan), s.applyCurrentZoomPan()));
  }
  end() {
    const {
      velocity: t
    ...
    if (this.pswp.animations.stopAll(), e.isShifted()) {
      ...
      t.x < -F && r < 0 || t.x < 0.1 && r < -0.5 ? (s = 1, t.x = Math.min(t.x, 0)) : (t.x > F && r > 0 || t.x > -0.1 && r > 0.5) && (s = -1, t.x = Math.max(t.x, 0)), e.moveIndexBy(s, !0, t.x);
    }
  ...
  _finishPanGestureForAxis(t) {
    ...
    const {
      pan: s,
      bounds: n
    } = i, r = s[t], a = this.pswp.bgOpacity < 1 && t === "y", l = r + ht(e[t], 0.995);
    if (a) {
      const g = this._getVerticalDragRatio(r), S = this._getVerticalDragRatio(l);
      if (g < 0 && S < -M || g > 0 && S > M) {
        this.pswp.close();
        return;
      }
  ...
  _panOrMoveMainScroll(t) {
    ...
    if (this.pswp.options.allowPanToNext && i === "x" && t === "x" && !n) {
      const u = a.getCurrSlideX(), m = a.x - u, g = h > 0, S = !g;
      if (c > d.min[t] && g) {
...
class pt {
  ...
  change() {
    ...
    if (!r.isZoomable() || n.mainScroll.isShifted())
      return;
    R(this._startZoomPoint, e, s), R(this._zoomPoint, t, i);
    let l = 1 / E(e, s) * E(t, i) * this._startZoomLevel;
...
class ut {
   ...
   */
  tap(t, e) {
    B(e) && this._doClickOrTapAction("tap", t, e);
  }
  /**
   * @param {Point} point
   * @param {PointerEvent} originalEvent
   */
  doubleTap(t, e) {
    B(e) && this._doClickOrTapAction("doubleTap", t, e);
  }
  /**
   * @private
...
class vt {
  ...
  _finishTap(t) {
    ...
    const i = this.pswp.options.doubleTapAction ? ft : 0;
    this._tapTimer ? (this._clearTapTimer(), E(this._lastStartP1, this.startP1) < _t && this.tapHandler.doubleTap(this.startP1, t)) : (p(this._lastStartP1, this.startP1), this._tapTimer = setTimeout(() => {
  ...
  _calculateDragDirection() {
    if (this.pswp.mainScroll.isShifted())
      ...
      if (t !== 0) {
        const e = t > 0 ? "x" : "y";
        Math.abs(this.p1[e] - this.startP1[e]) >= mt && (this.dragAxis = e);
      }
    }
  }
  /**
...
class yt {
  ...
  moveTo(t, e) {
    if (!this.pswp.canLoop() && e) {
      ...
      (i < 0 && s > 0 || i >= this.pswp.getNumItems() - 1 && s < 0) && (t = this.x + s * gt);
    }
...
class It {
  ...
  constructor(t) {
    ...
    this._target = i, this._onComplete = s, this._finished = !1, this._onTransitionEnd = this._onTransitionEnd.bind(this), this._helperTimeout = setTimeout(() => {
      H(i, l, a, h), this._helperTimeout = setTimeout(() => {
  ...
  destroy() {
    this._helperTimeout && clearTimeout(this._helperTimeout), J(this._target), this._target.removeEventListener("transitionend", this._onTransitionEnd, !1), this._target.removeEventListener("transitioncancel", this._onTransitionEnd, !1), this._finished || this._finalizeAnimation();
  }
}
const Ct = 12, xt = 0.75;
class Lt {
   ...
   */
  constructor(t, e, i) {
    this.velocity = t * 1e3, this._dampingRatio = e || xt, this._naturalFrequency = i || Ct, this._dampedFrequency = this._naturalFrequency, this._dampingRatio < 1 && (this._dampedFrequency *= Math.sqrt(1 - this._dampingRatio * this._dampingRatio));
  }
  /**
...
class Tt {
  ...
  constructor(t, e) {
    ...
    h.innerHTML = Et(n), e.onInit && e.onInit(h, t), e.onClick && (h.onclick = (c) => {
...
class Bt {
  ...
  init() {
    ...
    this.isRegistered = !1, this.uiElementsData = [Zt, Ot, Dt, Mt, Ft, Rt], t.dispatch("uiRegister"), this.uiElementsData.sort((e, i) => (e.order || 0) - (i.order || 0)), this.items = [], this.isRegistered = !0, this.uiElementsData.forEach((e) => {
   ...
   */
  registerElement(t) {
    this.isRegistered ? this.items.push(new Tt(this.pswp, t)) : this.uiElementsData.push(t);
  }
  /**
  ...
  _onZoomPanUpdate() {
    ...
    if (Math.abs(n) < 0.01 || !e.isZoomable()) {
      N(t, !1), t.classList.remove("pswp--zoom-allowed");
      return;
    }
    t.classList.add("pswp--zoom-allowed");
    const r = s === e.zoomLevels.initial ? e.zoomLevels.secondary : e.zoomLevels.initial;
    N(t, r <= s), (i.imageClickAction === "zoom" || i.imageClickAction === "zoom-or-close") && t.classList.add("pswp--click-to-zoom");
  }
}
function Nt(o) {
...
function kt(o, t, e) {
  ...
  return r = e.applyFilters("thumbEl", r, t, o), r && (t.thumbCropped ? n = $t(r, t.width || t.w || 0, t.height || t.h || 0) : n = Nt(r)), e.applyFilters("thumbBounds", n, t, o);
}
let Wt = class {
  /**
   * @param {T} type
  ...
  setDisplayedSize(t, e) {
    this.element && (this.element.tagName === "IMG" ? (T(this.element, 250, "auto"), this.element.style.transformOrigin = "0 0", this.element.style.transform = b(0, 0, t / 250)) : T(this.element, t, e));
  }
  destroy() {
    var t;
  ...
  setDisplayedSize(t, e) {
    if (this.element && (this.placeholder && this.placeholder.setDisplayedSize(t, e), !this.instance.dispatch("contentResize", {
      ...
      width: t,
      height: e
    }).defaultPrevented && (T(this.element, t, e), this.isImageContent() && !this.isError()))) {
...
function X(o, t, e) {
  ...
  if (n) {
    s = new q(n, o, -1);
    let r;
    t.pswp ? r = t.pswp.viewportSize : r = U(n, t);
    const a = G(n, r, o, e);
...
class Kt {
   ...
   */
  constructor(t) {
    this.pswp = t, this.limit = Math.max(t.options.preload[0] + t.options.preload[1] + 1, Gt), this._cachedItems = [];
  }
  /**
  ...
  loadSlideByIndex(t) {
    ...
    i || (i = qt(e, this.pswp), i && this.addToCache(i));
  }
  /**
   * @param {Slide} slide
   * @returns {Content}
...
let Xt = class extends Ht {
  ...
  _getGalleryDOMElements(t) {
    var e, i;
    return (e = this.options) !== null && e !== void 0 && e.children || (i = this.options) !== null && i !== void 0 && i.childSelector ? it(this.options.children, this.options.childSelector, t) || [] : [t];
  }
  /**
...
class Yt {
  ...
  _setClosedStateZoomPan(t) {
    ...
    if (this._croppedZoom && i && this._cropContainer1 && this._cropContainer2) {
      ...
      t ? (this._animateTo(this._cropContainer1, "transform", b(r, a)), this._animateTo(this._cropContainer2, "transform", b(h, l))) : (w(this._cropContainer1, r, a), w(this._cropContainer2, h, l));
    }
...
class _e extends Xt {
  ...
  constructor(t) {
    super(), this.options = this._prepareOptions(t || {}), this.offset = {
      ...
      x: 0,
      y: 0
    }, this.bgOpacity = 1, this.currIndex = 0, this.potentialIndex = 0, this.isOpen = !1, this.isDestroying = !1, this.hasMouse = !1, this._initialItemData = {}, this._initialThumbBounds = void 0, this.topBar = void 0, this.element = void 0, this.template = void 0, this.container = void 0, this.scrollWrap = void 0, this.currSlide = void 0, this.events = new st(), this.animations = new At(), this.mainScroll = new yt(this), this.gestures = new vt(this), this.opener = new Yt(this), this.keyboard = new St(this), this.contentLoader = new Kt(this);
  }
  /** @returns {boolean} */
  init() {
    ...
    let t = "pswp--open";
    return this.gestures.supportsTouch && (t += " pswp--touch"), this.options.mainClass && (t += " " + this.options.mainClass), this.element && (this.element.className += " " + t), this.currIndex = this.options.index || 0, this.potentialIndex = this.currIndex, this.dispatch("firstUpdate"), this.scrollWheel = new zt(this), (Number.isNaN(this.currIndex) || this.currIndex < 0 || this.currIndex >= this.getNumItems()) && (this.currIndex = 0), this.gestures.supportsTouch || this.mouseDetected(), this.updateSize(), this.offset.y = window.pageYOffset, this._initialItemData = this.getItemData(this.currIndex), this.dispatch("gettingData", {
  ...
  setContent(t, e, i) {
    ...
    t.slide = new ot(s, e, this), e === this.currIndex && (this.currSlide = t.slide), t.slide.append(t.el);
  }
  /** @returns {Point} */
  ...
  updateSize(t) {
    if (this.isDestroying)
      return;
    const e = U(this.options, this);
    !t && L(e, this._prevViewportSize) || (p(this._prevViewportSize, e), this.dispatch("beforeResize"), p(this.viewportSize, this._prevViewportSize), this._updatePageScrollOffset(), this.dispatch("viewportSize"), this.mainScroll.resize(this.opener.isOpen), !this.hasMouse && window.matchMedia("(any-hover: hover)").matches && this.mouseDetected(), this.dispatch("resize"));
  }
  /**
   ...
   */
  getThumbBounds() {
    return kt(this.currIndex, this.currSlide ? this.currSlide.data : this._initialItemData, this);
  }
  /**
...
class se {
   ...
   */
  constructor(t, e) {
    if (this.element = C("pswp__img pswp__img--placeholder", t ? "img" : "div", e), t) {
      const i = (
        /** @type {HTMLImageElement} */
        this.element
      );
   ...
   */
  setDisplayedSize(t, e) {
    this.element && (this.element.tagName === "IMG" ? (O(this.element, 250, "auto"), this.element.style.transformOrigin = "0 0", this.element.style.transform = Qt(0, 0, t / 250)) : O(this.element, t, e));
  }
  destroy() {
    var t;
    (t = this.element) !== null && t !== void 0 && t.parentNode && this.element.remove(), this.element = null;
...
class ne {
  ...
  load(t, e) {
    ...
    this.element && !e || this.instance.dispatch("contentLoad", {
      content: this,
      isLazy: t
    }).defaultPrevented || (this.isImageContent() ? (this.element = C("pswp__img", "img"), this.displayedImageWidth && this.loadImage(t)) : (this.element = C("pswp__content", "div"), this.element.innerHTML = this.data.html || ""), e && this.slide && this.slide.updateContentSize(!0));
  }
  /**
   * Preload image
   *
  ...
  displayError() {
    if (this.slide) {
      var t, e;
      let i = C("pswp__error-msg", "div");
      i.innerText = (t = (e = this.instance.options) === null || e === void 0 ? void 0 : e.errorMsg) !== null && t !== void 0 ? t : "", i = /** @type {HTMLDivElement} */
      this.instance.applyFilters("contentErrorElement", i, this), this.element = C("pswp__content pswp__error-msg-container", "div"), this.element.appendChild(i), this.slide.container.innerText = "", this.slide.container.appendChild(this.element), this.slide.updateContentSize(!0), this.removePlaceholder();
    }
  }
  /**
   * Append the content
  ...
  append() {
    ...
    if (this.instance.dispatch("contentAppend", {
      ...
      return;
    const t = "decode" in this.element;
    this.isImageContent() ? t && this.slide && (!this.slide.isActive || $()) ? (this.isDecoding = !0, this.element.decode().catch(() => {
    }).finally(() => {
      this.isDecoding = !1, this.appendImage();
    })) : this.appendImage() : this.slide && !this.element.parentNode && this.slide.container.appendChild(this.element);
  }
  ...
  activate() {
    this.instance.dispatch("contentActivate", {
      content: this
    }).defaultPrevented || !this.slide || (this.isImageContent() && this.isDecoding && !$() ? this.appendImage() : this.isError() && this.load(!1, !0), this.slide.holderElement && this.slide.holderElement.setAttribute("aria-hidden", "false"));
  }
  /**
   * Deactivate the content
   */
...
function re(o, t, e, i) {
  return {
    x: t.x - z("left", o, t, e, i) - z("right", o, t, e, i),
    y: t.y - z("top", o, t, e, i) - z("bottom", o, t, e, i)
  };
}
const k = 4e3;
class ae {
  ...
  _getSecondary() {
    let t = this._parseZoomLevelOption("secondary");
    return t || (t = Math.min(1, this.fit * 3), this.elementSize && t * this.elementSize.x > k && (t = k / this.elementSize.x), t);
  }
  /**
   * Get initial image zoom level.
   *
...
function Y(o, t, e) {
  ...
  if (n) {
    s = new ae(n, o, -1);
    let r;
    t.pswp ? r = t.pswp.viewportSize : r = oe(n, t);
    const a = re(n, r, o, e);
    s.update(i.width, i.height, a);
  }
  return i.lazyLoad(), s && i.setDisplayedSize(Math.ceil(i.width * s.initial), Math.ceil(i.height * s.initial)), i;
...
class le extends ie {
  ...
  _getGalleryDOMElements(t) {
    var e, i;
    return (e = this.options) !== null && e !== void 0 && e.children || (i = this.options) !== null && i !== void 0 && i.childSelector ? x(this.options.children, this.options.childSelector, t) || [] : [t];
  }
  /**
   * Converts DOM element to item data object.
   *
...
class ve extends le {
   ...
   */
  init() {
    x(this.options.gallery, this.options.gallerySelector).forEach((t) => {
  ...
  loadAndOpen(t, e, i) {
    ...
    if (!e && this.options.gallery && this.options.children) {
      const s = x(this.options.gallery);
      s[0] && (e = {
        gallery: s[0]
      });
    }
  ...
  preload(t, e) {
    ...
    typeof i.openPromise == "function" && s.push(i.openPromise()), i.preloadFirstSlide !== !1 && t >= 0 && (this._preloadedContent = he(t, this));
    const r = ++this._uid;
  ...
  destroy() {
    var t;
    (t = this.pswp) === null || t === void 0 || t.destroy(), this.shouldOpen = !1, this._listeners = {}, x(this.options.gallery, this.options.gallerySelector).forEach((e) => {
      e.removeEventListener("click", this.onThumbnailsClick, !1);
    });
  }
}
export {
  ve as PhotoSwipeLightbox,
  _e as default
};
