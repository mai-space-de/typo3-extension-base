...
var gt = (l, e, t) => e in l ? mt(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var b = (l, e, t) => gt(l, typeof e != "symbol" ? e + "" : e, t);
class k {
  constructor(e) {
    this.table = e;
  }
...
let bt = class Ue extends k {
  ...
  containerEventCoords(e) {
    ...
    if (this.container !== document.body) {
      let n = R.elOffset(this.container);
      i -= n.left, s -= n.top;
    }
    return { x: i, y: s };
  }
  elementPositionCoords(e, t = "right") {
    var i = R.elOffset(e), s, n, r;
    switch (this.container !== document.body && (s = R.elOffset(this.container), i.left -= s.left, i.top -= s.top), t) {
      case "right":
  ...
  child(e) {
    return this.childPopup && this.childPopup.hide(), this.childPopup = new Ue(this.table, e, this), this.childPopup;
  }
};
class w extends k {
  constructor(e, t) {
...
const Y = class Y extends w {
  ...
  lookupAccessor(e) {
    ...
    switch (typeof e) {
      case "string":
        Y.accessors[e] ? t = Y.accessors[e] : console.warn("Accessor Error - No such accessor found, ignoring: ", e);
        break;
      case "function":
        t = e;
        break;
  ...
  transformRow(e, t) {
    var i = "accessor" + (t.charAt(0).toUpperCase() + t.slice(1)), s = e.getComponent(), n = R.deepClone(e.data || {});
...
b(Y, "moduleName", "accessor"), //load defaults
b(Y, "accessors", vt);
let ce = Y;
var wt = {
  method: "GET"
...
function fe(l, e) {
  ...
  if (e = e || "", Array.isArray(l))
    l.forEach((s, n) => {
      t = t.concat(fe(s, e ? e + "[" + n + "]" : n));
    });
  else if (typeof l == "object")
    for (var i in l)
      t = t.concat(fe(l[i], e ? e + "[" + i + "]" : i));
  else
...
function Xe(l, e, t) {
  return l && t && Object.keys(t).length && (!e.method || e.method.toLowerCase() == "get") && (e.method = "get", l += (l.includes("?") ? "&" : "?") + Ct(t)), l;
}
function Et(l, e, t) {
  var i;
...
const F = class F extends w {
  constructor(e) {
    ...
    }), this.registerTableOption("ajaxResponse", !1), this.contentTypeFormatters = F.contentTypeFormatters;
  }
  ...
  setDefaultConfig(e = {}) {
    this.config = Object.assign({}, F.defaultConfig), typeof e == "string" ? this.config.method = e : Object.assign(this.config, e);
  }
  //load config object
  generateConfig(e = {}) {
...
b(F, "moduleName", "ajax"), //load defaults
b(F, "defaultConfig", wt), b(F, "defaultURLGenerator", Xe), b(F, "defaultLoaderPromise", Et), b(F, "contentTypeFormatters", yt);
let me = F;
var Rt = {
  replace: function(l) {
...
`);
  ...
  setPasteAction(e) {
    switch (typeof e) {
      case "string":
        this.pasteAction = _.pasteActions[e], this.pasteAction || console.warn("Clipboard Error - No such paste action found:", e);
        break;
      case "function":
        this.pasteAction = e;
        break;
  ...
  setPasteParser(e) {
    switch (typeof e) {
      case "string":
        this.pasteParser = _.pasteParsers[e], this.pasteParser || console.warn("Clipboard Error - No such paste parser found:", e);
        break;
      case "function":
        this.pasteParser = e;
        break;
...
b(_, "moduleName", "clipboard"), b(_, "moduleExtensions", kt), //load defaults
b(_, "pasteActions", Rt), b(_, "pasteParsers", xt);
let ge = _;
class Lt {
  constructor(e) {
...
class re extends k {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new Je(this)), this.component;
  }
}
class Ke {
  constructor(e) {
...
const j = class j extends k {
  ...
  mapDefinitions() {
    ...
    this.definition = this.table.columnManager.optionsList.generate(j.defaultOptionList, this.definition);
  }
  checkDefinition() {
    Object.keys(this.definition).forEach((e) => {
      j.defaultOptionList.indexOf(e) === -1 && console.warn("Invalid column definition option in '" + (this.field || this.definition.title) + "' column:", e);
    });
  }
  setField(e) {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new Ke(this)), this.component;
  }
  getPosition() {
    return this.table.columnManager.getVisibleColumnsByIndex().indexOf(this) + 1;
  }
  getParentComponent() {
    return this.parent instanceof j ? this.parent.getComponent() : !1;
  }
};
b(j, "defaultOptionList", qe);
let J = j;
class ae {
  constructor(e) {
    return this._row = e, new Proxy(this, {
...
class L extends k {
  ...
  updateData(e) {
    var t = this.element && R.elVisible(this.element), i = {}, s;
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new ae(this)), this.component;
  }
}
var St = {
  avg: function(l, e, t) {
...
const B = class B extends w {
  ...
  generateRow(e, t) {
    ...
    return this.table.modExists("mutator") && this.table.modules.mutator.disable(), s = new L(i, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), s.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), s.component = !1, s.getComponent = () => (s.component || (s.component = new Lt(s)), s.component), s.generateCells = () => {
      var n = [];
...
b(B, "moduleName", "columnCalcs"), //load defaults
b(B, "calculations", St);
let be = B;
class Ye extends w {
  constructor(e) {
  ...
  getRows(e) {
    ...
    return e.forEach((i, s) => {
      var n, r;
      t.push(i), i instanceof L && (i.create(), n = i.modules.dataTree, !n.index && n.children !== !1 && (r = this.getChildren(i, !1, !0), r.forEach((o) => {
        o.create(), t.push(o);
      })));
    }), t;
  }
  ...
  generateChildren(e) {
    ...
    return Array.isArray(i) || (i = [i]), i.forEach((s) => {
      var n = new L(s || {}, this.table.rowManager);
  ...
  getTreeChildren(e, t, i) {
    ...
    return s && s.children && (Array.isArray(s.children) || (s.children = this.generateChildren(e)), s.children.forEach((r) => {
      r instanceof L && (n.push(t ? r.getComponent() : r), i && this.getTreeChildren(r, t, i).forEach((o) => {
        n.push(o);
      }));
    })), n;
  }
...
function Ft(l, e, t) {
  ...
  function u() {
    var p = [], g = [], v = {}, m = { s: { c: 0, r: 0 }, e: { c: l[0] ? l[0].columns.reduce((C, T) => C + (T && T.width ? T.width : 1), 0) : 0, r: l.length } };
    return l.forEach((C, T) => {
      var M = [];
      C.columns.forEach(function(x, D) {
        x ? (M.push(!(x.value instanceof Date) && typeof x.value == "object" ? JSON.stringify(x.value) : x.value), (x.width > 1 || x.height > -1) && (x.height > 1 || x.width > 1) && g.push({ s: { r: T, c: D }, e: { r: T + x.height - 1, c: D + x.width - 1 } })) : M.push("");
      }), p.push(M);
  ...
  function f(p) {
    for (var g = new ArrayBuffer(p.length), v = new Uint8Array(g), m = 0; m != p.length; ++m) v[m] = p.charCodeAt(m) & 255;
    return g;
  }
...
const $ = class $ extends w {
  ...
  download(e, t, i, s, n) {
    ...
    if (typeof e == "function" ? r = e : $.downloaders[e] ? r = $.downloaders[e] : console.warn("Download Error - No such download type found: ", e), r) {
...
b($, "moduleName", "download"), //load defaults
b($, "downloaders", Ot);
let ve = $;
function le(l, e) {
...
let jt = class {
  ...
  _createInputElement() {
    ...
    return this.params.mask && le(t, this.params), this._bindInputEvents(t), t;
  }
  _initializeParams(e) {
  ...
  _ajaxRequest(e, t) {
    ...
    return e = Xe(e, {}, i), fetch(e).then((s) => s.ok ? s.json().catch((n) => (console.warn("List Ajax Load Error - Invalid JSON returned", n), Promise.reject(n))) : (console.error("List Ajax Load Error - Connection Error: " + s.status, s.statusText), Promise.reject(s))).catch((s) => (console.error("List Ajax Load Error - Connection Error: ", s), Promise.reject(s)));
  }
...
function Ut(l, e, t, i, s) {
  var n = new jt(this, l, e, t, i, s);
  return n.input;
}
function Xt(l, e, t, i, s) {
...
function Jt(l, e, t, i, s) {
  ...
  function p() {
    var g = window.getComputedStyle(n, null), v = a * Math.round(u.offsetWidth / ((n.clientWidth - parseInt(g.getPropertyValue("padding-left")) - parseInt(g.getPropertyValue("padding-right"))) / 100)) + o;
    t(v), n.setAttribute("aria-valuenow", v), n.setAttribute("aria-label", h);
  }
  ...
  findNextEditableCell(e, t) {
    ...
    if (t < e.cells.length - 1)
      for (var s = t + 1; s < e.cells.length; s++) {
        let n = e.cells[s];
        if (n.column.modules.edit && R.elVisible(n.getElement()) && this.allowEdit(n)) {
          i = n;
          break;
        }
      }
  ...
  edit(e, t, i) {
    ...
    function c(m) {
      if (s.currentCell === e && !a) {
        var C = s.chain("edit-success", [e, m], !0, !0);
        return C === !0 || s.table.options.validationMode === "highlight" ? (a = !0, s.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, s.editedCells.indexOf(e) == -1 && s.editedCells.push(e), m = s.transformEmptyValues(m, e), e.setValue(m, !0), C === !0) : (a = !0, s.invalidEdit = !0, s.focusCellNoEvent(e, !0), r(), setTimeout(() => {
          a = !1;
        }, 10), !1);
      }
    }
    ...
    if (t && t.stopPropagation(), n = this.allowEdit(e), n || i) {
      if (s.cancelEdit(), s.currentCell = e, this.focusScrollAdjust(e), d = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, d)), e.column.definition.cellEditing && e.column.definition.cellEditing.call(this.table, d), this.dispatch("cell-editing", e), this.dispatchExternal("cellEditing", d), u = typeof e.column.modules.edit.params == "function" ? e.column.modules.edit.params(d) : e.column.modules.edit.params, h = e.column.modules.edit.editor.call(s, d, p, c, f, u), this.currentCell && h !== !1)
        if (h instanceof Node) {
          ...
          o.appendChild(h), r();
          for (var g = o.children, v = 0; v < g.length; v++)
            g[v].addEventListener("click", function(m) {
              m.stopPropagation();
            });
        } else
...
b(ee, "moduleName", "edit"), //load defaults
b(ee, "editors", Yt);
let we = ee;
class We {
  constructor(e, t, i, s) {
...
const V = class V extends w {
  ...
  generateExportList(e, t, i, s) {
    var n, r, o, a;
    return this.cloneTableStyle = t, this.config = e || {}, this.colVisProp = s, this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1), a = V.columnLookups[i], a && (o = a.call(this.table), o = o.filter((h) => this.columnVisCheck(h))), n = this.config.columnHeaders !== !1 ? this.headersToExportRows(this.generateColumnGroupHeaders(o)) : [], o && (o = o.map((h) => h.getComponent())), r = this.bodyToExportRows(this.rowLookup(i), o), n.concat(r);
  }
  ...
  rowLookup(e) {
    ...
    }) : (i = V.rowLookups[e] || V.rowLookups.active, t = i.call(this.table)), Object.assign([], t);
  }
    ...
    return e.forEach(function(r) {
      ...
      r.forEach((a) => {
        if (a) {
          ...
          o.push(new de(h, a.column.getComponent(), a.width, a.height, a.depth));
        } else
          o.push(null);
      }), s.push(new We("header", o));
    }), s;
  }
  bodyToExportRows(e, t = []) {
    ...
    return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((s) => {
      ...
      switch (s.type) {
        case "group":
          a = s.level, o.push(new de(s.key, s.getComponent(), t.length, 1));
          break;
        case "calc":
        case "row":
          t.forEach((h) => {
            o.push(new de(h._column.getFieldValue(r), h, 1, 1));
          }), this.table.options.dataTree && this.config.dataTree !== !1 && (a = s.modules.dataTree.index);
          break;
      }
      i.push(new We(s.type, o, s.getComponent(), a));
    }), i;
  }
...
b(V, "moduleName", "export"), b(V, "columnLookups", $t), b(V, "rowLookups", Qt);
let Ce = V;
var Zt = {
  //equal to
  "=": function(l, e, t, i) {
  ...
  generateHeaderFilterElement(e, t, i) {
    ...
    if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), r) {
      ...
      if (a) {
        ...
        }, f = e.definition.headerFilterParams || {}, f = typeof f == "function" ? f.call(s.table, d) : f, h = a.call(this.table.modules.edit, d, v, n, g, f), !h) {
        ...
        s.langBind("headerFilters|columns|" + e.definition.field, function(m) {
          ...
          var C = this.table.columnManager.contentsElement.scrollLeft, T = this.table.rowManager.element.scrollLeft;
          C !== T && (this.table.rowManager.scrollHorizontal(C), this.table.columnManager.scrollHorizontal(C));
        }), u = !1, c = function(m) {
...
b(P, "moduleName", "filter"), //load defaults
b(P, "filters", Zt);
let Ee = P;
function ei(l, e, t) {
...
function ni(l, e, t) {
  ...
  if (r) {
    if (e.urlField && (a = l.getData(), i = R.retrieveNestedData(this.table.options.nestedFieldSeparator, e.urlField, a)), e.url)
      switch (typeof e.url) {
        case "string":
          i = e.url;
          break;
...
function ci(l, e = {}, t) {
  ...
  switch (h = parseFloat(i) <= n ? parseFloat(i) : n, h = parseFloat(h) >= r ? parseFloat(h) : r, a = (n - r) / 100, h = Math.round((h - r) / a), typeof e.color) {
    ...
    case "object":
      if (Array.isArray(e.color)) {
        let v = 100 / e.color.length, m = Math.floor(h / v);
  ...
  switch (typeof e.legendColor) {
    ...
    case "object":
      if (Array.isArray(e.legendColor)) {
        let v = 100 / e.legendColor.length, m = Math.floor(h / v);
  ...
  return t(function() {
    if (!(l instanceof Je)) {
      ...
      v.style.position = "absolute", v.style.top = "4px", v.style.bottom = "4px", v.style.left = "4px", v.style.right = "4px", s.appendChild(v), s = v;
    }
...
function Ci(l, e, t) {
  ...
  return e.valueMap && (typeof e.valueMap == "string" ? r = function(o) {
    return o.map((a) => R.retrieveNestedData(n.options.nestedFieldSeparator, e.valueMap, a));
...
b(I, "moduleName", "format"), //load defaults
b(I, "formatters", yi);
let ye = I;
class $e extends w {
  constructor(e) {
...
class q {
  ...
  _createGroup(e, t) {
    var i = t + "_" + e, s = new q(this.groupManager, this, t, e, this.groupManager.groupIDLookups[t].field, this.groupManager.headerGenerator[t] || this.groupManager.headerGenerator[0], this.old ? this.old.groups[i] : !1);
...
class Ze extends w {
  ...
  rowMoving(e, t, i) {
    if (this.table.options.groupBy) {
      !i && t instanceof q && (t = this.table.rowManager.prevDisplayRow(e) || t);
      var s = t instanceof q ? t : t.modules.group, n = e instanceof q ? e : e.modules.group;
  ...
  createGroup(e, t, i) {
    var s = t + "_" + e, n;
    i = i || [], n = new q(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], i[s]), this.groups[s] = n, this.groupList.push(n);
  }
...
const N = class N extends w {
  ...
  _rebindRow(e, t) {
    this.history.forEach(function(i) {
      if (i.component instanceof L)
        i.component === e && (i.component = t);
      else if (i.component instanceof re && i.component.row === e) {
...
b(N, "moduleName", "history"), b(N, "moduleExtensions", Li), //load defaults
b(N, "undoers", xi), b(N, "redoers", Ti);
let Re = N;
class et extends w {
  constructor(e) {
...
b(et, "moduleName", "htmlTableImport");
function Si(l) {
  var e = [], t = 0, i = 0, s = !1;
...
const te = class te extends w {
  ...
  lookupImporter(e) {
    var t;
    return e || (e = this.table.options.importFormat), typeof e == "string" ? t = te.importers[e] : t = e, t || console.error("Import Error - Importer not found:", e), t;
  }
...
b(te, "moduleName", "import"), //load defaults
b(te, "importers", Fi);
let xe = te;
class tt extends w {
  constructor(e) {
  ...
  dispatchEvent(e, t, i) {
    ...
    this.columnSubscribers[e] && (i instanceof re ? n = i.column.definition[e] : i instanceof J && (n = i.definition[e]), n && n(t, s)), this.dispatchExternal(e, t, s);
  }
}
...
b(W, "moduleName", "keybindings"), //load defaults
b(W, "bindings", Ai), b(W, "actions", Pi);
let Te = W;
class it extends w {
  constructor(e) {
...
class st extends w {
  ...
  initializeColumn(e) {
    ...
    !e.modules.frozen && !e.isGroup && !e.isRowHeader && (s = e.getElement(), i.mousemove = (function(n) {
      e.parent === t.moving.parent && ((t.touchMove ? n.touches[0].pageX : n.pageX) - R.elOffset(s).left + t.table.columnManager.contentsElement.scrollLeft > e.getWidth() / 2 ? (t.toCol !== e || !t.toColAfter) && (s.parentNode.insertBefore(t.placeholderElement, s.nextSibling), t.moveColumn(e, !0)) : (t.toCol !== e || t.toColAfter) && (s.parentNode.insertBefore(t.placeholderElement, s), t.moveColumn(e, !1)));
  ...
  moveHover(e) {
    var t = this.table.columnManager.getContentsElement(), i = t.scrollLeft, s = (this.touchMove ? e.touches[0].pageX : e.pageX) - R.elOffset(t).left + i, n;
...
const U = class U extends w {
  ...
  initializeGroupHeader(e) {
    ...
    i.mouseup = (function(s) {
      ...
      var n;
      s.pageY - R.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (n = e.getElement(), n.parentNode.insertBefore(t.placeholderElement, n.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (n = e.getElement(), n.previousSibling && (n.parentNode.insertBefore(t.placeholderElement, n), t.moveRow(e, !1)));
  ...
  initializeRow(e) {
    ...
    i.mouseup = (function(n) {
      ...
      var r = e.getElement();
      n.pageY - R.elOffset(r).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r), t.moveRow(e, !1));
  ...
  dropComplete(e, t, i) {
    ...
    if (i) {
      switch (typeof this.table.options.movableRowsSender) {
        case "string":
          s = U.senders[this.table.options.movableRowsSender];
          break;
        case "function":
  ...
  tableRowDrop(e, t) {
    ...
    switch (e.stopImmediatePropagation(), typeof this.table.options.movableRowsReceiver) {
      case "string":
        i = U.receivers[this.table.options.movableRowsReceiver];
        break;
      case "function":
...
b(U, "moduleName", "moveRow"), //load defaults
b(U, "senders", Oi), b(U, "receivers", _i);
let Me = U;
var Bi = {};
const Q = class Q extends w {
  ...
  lookupMutator(e) {
    ...
    switch (typeof e) {
      case "string":
        Q.mutators[e] ? t = Q.mutators[e] : console.warn("Mutator Error - No such mutator found, ignoring: ", e);
        break;
      case "function":
        t = e;
        break;
...
b(Q, "moduleName", "mutator"), //load defaults
b(Q, "mutators", Bi);
let ke = Q;
...
const ie = class ie extends w {
  ...
  initializePageCounter() {
    ...
    e && (typeof e == "function" ? t = e : t = ie.pageCounters[e], t ? (this.pageCounter = t, this.pageCounterElement = document.createElement("span"), this.pageCounterElement.classList.add("tabulator-page-counter")) : console.warn("Pagination Error - No such page counter found: ", e));
  }
  //setup pagination
...
b(ie, "moduleName", "page"), //load defaults
b(ie, "pageCounters", Ni);
let Le = ie;
var Wi = {
  local: function(l, e) {
...
const S = class S extends w {
  ...
  initialize() {
    if (this.table.options.persistence) {
      ...
      this.mode = e !== !0 ? e : this.localStorageTest() ? "local" : "cookie", this.table.options.persistenceReaderFunc ? typeof this.table.options.persistenceReaderFunc == "function" ? this.readFunc = this.table.options.persistenceReaderFunc : S.readers[this.table.options.persistenceReaderFunc] ? this.readFunc = S.readers[this.table.options.persistenceReaderFunc] : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc) : S.readers[this.mode] ? this.readFunc = S.readers[this.mode] : console.warn("Persistence Read Error - invalid reader set", this.mode), this.table.options.persistenceWriterFunc ? typeof this.table.options.persistenceWriterFunc == "function" ? this.writeFunc = this.table.options.persistenceWriterFunc : S.writers[this.table.options.persistenceWriterFunc] ? this.writeFunc = S.writers[this.table.options.persistenceWriterFunc] : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc) : S.writers[this.mode] ? this.writeFunc = S.writers[this.mode] : console.warn("Persistence Write Error - invalid writer set", this.mode), this.id = "tabulator-" + (t || this.table.element.getAttribute("id") || ""), this.config = {
...
b(S, "moduleName", "persistence"), b(S, "moduleInitOrder", -10), //load defaults
b(S, "readers", Wi), b(S, "writers", Gi);
let Se = S;
class nt extends w {
  constructor(e) {
...
b(De, "moduleName", "responsiveLayout"), b(De, "moduleExtensions", Ui);
function Xi(l, e, t) {
  ...
  if (i.type = "checkbox", i.setAttribute("aria-label", "Select Row"), this.table.modExists("selectRow", !0))
    if (i.addEventListener("click", (r) => {
      ...
      var n = l.getRow();
      n instanceof ae ? (i.addEventListener("change", (r) => {
...
b(ze, "moduleName", "selectRow"), b(ze, "moduleExtensions", Ji);
class Ki {
  constructor(e) {
...
class oe extends w {
  ...
  navigate(e, t, i) {
    ...
    if (this.table.modules.edit && this.table.modules.edit.currentCell)
      return !1;
    if (this.ranges.length > 1 && (this.ranges = this.ranges.filter((v) => v === this.activeRange ? (v.setEnd(v.start.row, v.start.col), !0) : (v.destroy(), !1))), n = this.activeRange, o = {
      top: n.top,
      bottom: n.bottom,
      left: n.left,
      right: n.right
  ...
  addRange(e, t) {
    var i;
    return this.maxRanges !== !0 && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), i = new qi(this.table, this, e, t), this.activeRange = i, this.ranges.push(i), this.rangeContainer.appendChild(i.element), i;
  }
  resetRanges() {
    var e, t, i;
...
b(oe, "moduleName", "selectRange"), b(oe, "moduleInitOrder", 1), b(oe, "moduleExtensions", is);
...
function rs(l, e, t, i, s, n, r) {
  return r.format || (r.format = "dd/MM/yyyy"), Be.call(this, l, e, t, i, s, n, r);
}
function os(l, e, t, i, s, n, r) {
  return r.format || (r.format = "HH:mm"), Be.call(this, l, e, t, i, s, n, r);
}
function as(l, e, t, i, s, n, r) {
...
function ls(l, e, t, i, s, n, r) {
  ...
  r.valueMap && (typeof r.valueMap == "string" ? u = function(f) {
    return f.map((p) => R.retrieveNestedData(d.options.nestedFieldSeparator, r.valueMap, p));
  } : u = r.valueMap);
  function c(f) {
    var p;
    switch (u && (f = u(f)), o) {
...
function hs(l, e, t, i, s, n, r) {
  var o = typeof l > "u" ? 0 : 1, a = typeof e > "u" ? 0 : 1;
  return o - a;
}
function ds(l, e, t, i, s, n, r) {
  var o, a, h, d, u = 0, c, f = /(\d+)|(\D+)/g, p = /\d/, g = r.alignEmptyValues, v = 0;
  if (!l && l !== 0)
    v = !e && e !== 0 ? 0 : -1;
  else if (!e && e !== 0)
    v = 1;
  ...
  return (g === "top" && n === "desc" || g === "bottom" && n === "asc") && (v *= -1), v;
}
var us = {
  number: ss,
  string: ns,
...
b(X, "moduleName", "sort"), //load defaults
b(X, "sorters", us);
let He = X;
class cs {
  constructor(e, t) {
...
Data:     `, e), !1;
  ...
  newSheet(e = {}) {
    var t;
    return e.rows || (e.rows = this.options("spreadsheetRows")), e.columns || (e.columns = this.options("spreadsheetColumns")), t = new Ge(this, e), this.sheets.push(t), this.element && this.element.appendChild(t.element), t;
  }
  removeSheet(e) {
  ...
  lookupSheet(e) {
    return e ? e instanceof Ge ? e : e instanceof dt ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
  }
  ///////////////////////////////////
  //////// Public Functions /////////
  ///////////////////////////////////
...
class ct extends w {
  ...
  loadTooltip(e, t, i) {
    ...
    typeof i == "function" && (i = i(e, t.getComponent(), o)), i instanceof HTMLElement ? s = i : (s = document.createElement("div"), i === !0 && (t instanceof re ? i = t.value : t.definition.field ? this.langBind("columns|" + t.definition.field, (a) => {
...
const se = class se extends w {
  ...
  _buildValidator(e, t) {
    var i = typeof e == "function" ? e : se.validators[e];
    return i ? {
...
b(se, "moduleName", "validate"), //load defaults
b(se, "validators", fs);
let Fe = se;
var ue = /* @__PURE__ */ Object.freeze({
  ...
  FilterModule: Ee,
  FormatModule: ye,
  FrozenColumnsModule: $e,
  FrozenRowsModule: Qe,
  GroupRowsModule: Ze,
  HistoryModule: Re,
  HtmlTableImportModule: et,
  ImportModule: xe,
  InteractionModule: tt,
  KeybindingsModule: Te,
  MenuModule: it,
  MoveColumnsModule: st,
  MoveRowsModule: Me,
  MutatorModule: ke,
  PageModule: Le,
  PersistenceModule: Se,
  PopupModule: nt,
  PrintModule: rt,
  ReactiveDataModule: ot,
  ResizeColumnsModule: at,
  ResizeRowsModule: lt,
  ResizeTableModule: ht,
  ResponsiveLayoutModule: De,
  SelectRangeModule: oe,
  SelectRowModule: ze,
  SortModule: He,
  SpreadsheetModule: ut,
  TooltipModule: ct,
  ValidateModule: Fe
}), ps = {
...
class he extends k {
  ...
  scrollToRowPosition(e, t, i) {
    ...
    return new Promise((o, a) => {
      if (s > -1) {
        if (typeof i > "u" && (i = this.table.options.scrollToRowIfVisible), !i && R.elVisible(n) && (r = R.elOffset(n).top - R.elOffset(this.elementVertical).top, r > 0 && r < this.elementVertical.clientHeight - n.offsetHeight))
          return o(), !1;
...
class bs extends k {
  constructor(e) {
    super(e), this.blockHozScrollEvent = !1, this.headersElement = null, this.contentsElement = null, this.rowHeader = null, this.element = null, this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.scrollLeft = 0, this.optionsList = new ft(this.table, "column definition", qe), this.redrawBlock = !1, this.redrawBlockUpdate = null, this.renderer = null;
  }
  ////////////// Setup Functions /////////////////
  initialize() {
  ...
  setColumns(e, t) {
    ...
    this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.dispatch("columns-loading"), this.dispatchExternal("columnsLoading"), this.table.options.rowHeader && (this.rowHeader = new J(this.table.options.rowHeader === !0 ? {} : this.table.options.rowHeader, this, !0), this.columns.push(this.rowHeader), this.headersElement.appendChild(this.rowHeader.getElement()), this.rowHeader.columnRendered()), e.forEach((i, s) => {
      this._addColumn(i);
  ...
  _addColumn(e, t, i) {
    var s = new J(e, this), n = s.getElement(), r = i && this.findColumnIndex(i);
...
class ws extends he {
  ...
  _virtualRenderFill(e, t, i) {
    var s = this.tableElement, n = this.elementVertical, r = 0, o = 0, a = 0, h = 0, d = 0, u = 0, c = this.rows(), f = c.length, p = 0, g, v, m = [], C = 0, T = 0, M = this.table.rowManager.fixedHeight, x = this.elementVertical.clientHeight, D = this.table.options.rowHeight, K = !0;
    if (e = e || 0, i = i || 0, !e)
      this.clear();
    else {
      for (; s.firstChild; ) s.removeChild(s.firstChild);
      h = (f - e + 1) * this.vDomRowHeight, h < x && (e -= Math.ceil((x - h) / this.vDomRowHeight), e < 0 && (e = 0)), r = Math.min(Math.max(Math.floor(this.vDomWindowBuffer / this.vDomRowHeight), this.vDomWindowMinMarginRows), e), e -= r;
    }
    if (f && R.elVisible(this.elementVertical)) {
      for (this.vDomTop = e, this.vDomBottom = e - 1, M || this.table.options.maxHeight ? (D && (T = x / D + this.vDomWindowBuffer / D), T = Math.max(this.vDomWindowMinTotalRows, Math.ceil(T))) : T = f; (T == f || o <= x + this.vDomWindowBuffer || C < this.vDomWindowMinTotalRows) && this.vDomBottom < f - 1; ) {
        for (m = [], v = document.createDocumentFragment(), u = 0; u < T && this.vDomBottom < f - 1; )
        ...
        if (!m.length)
          break;
        s.appendChild(v), m.forEach((z) => {
          z.rendered();
        });
        const A = [];
        m.forEach((z) => {
          z.heightInitialized || (z.calcHeight(!0), A.push(z));
        }), A.forEach((z) => {
          z.setCellHeight();
        }), m.forEach((z) => {
          a = z.getHeight(), C < r ? d += a : o += a, a > this.vDomWindowBuffer && (this.vDomWindowBuffer = a * 2), C++;
        }), K = this.table.rowManager.adjustTableSize(), x = this.elementVertical.clientHeight, K && (M || this.table.options.maxHeight) && (D = o / C, T = Math.max(this.vDomWindowMinTotalRows, Math.ceil(x / D + this.vDomWindowBuffer / D)));
      }
...
Data:     `, e);
  ...
  addRowActual(e, t, i, s) {
    var n = e instanceof L ? e : new L(e || {}, this), r = this.findAddRowPos(t), o = -1, a, h;
  ...
  nextDisplayRow(e, t) {
    ...
    return i !== !1 && i < this.displayRowsCount - 1 && (s = this.getDisplayRows()[i + 1]), s && (!(s instanceof L) || s.type != "row") ? this.nextDisplayRow(s, t) : s;
  }
  prevDisplayRow(e, t) {
    var i = this.getDisplayRowIndex(e), s = !1;
    return i && (s = this.getDisplayRows()[i - 1]), t && s && (!(s instanceof L) || s.type != "row") ? this.prevDisplayRow(s, t) : s;
  }
  findRowIndex(e, t) {
    var i;
  ...
  refreshActiveData(e, t, i) {
    ...
    if (!this.table.destroyed) {
      ...
      if (this.redrawBlock) {
        ...
        R.elVisible(this.element) ? i ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, n, r, i)) : (this.refreshPipelines(e, n, r, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0)) : this.refreshPipelines(e, n, r, i), this.dispatch("data-refreshed");
    }
  }
      ...
      if (u && u.target === d)
        ...
        switch (a) {
          ...
          case "column":
            ...
            break;
          case "cell":
            s.components.includes("cell") && (n.row instanceof L ? h = n.row.findCell(d) : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"));
            break;
        }
      h && (n[a] = h, o[a] = {
        target: d,
...
function zs(l, e) {
  ...
  function f(p, g, v, m) {
    var C = [], T = 0, M = 0, x = 0, D = n, K = 0, A = 0, z = [];
    function Ve(E) {
    ...
    return p.forEach(function(E, Os) {
      var Ne = m ? Ie(E) : Ve(E);
      E.column.minWidth >= Ne ? C.push(E) : E.column.maxWidth && E.column.maxWidth < Ne ? (E.width = E.column.maxWidth, g -= E.column.maxWidth, D -= m ? E.column.definition.widthShrink || 1 : E.column.definition.widthGrow || 1, D && (v = Math.floor(g / D))) : (z.push(E), A += m ? E.column.definition.widthShrink || 1 : E.column.definition.widthGrow || 1);
    }), C.length ? (C.forEach(function(E) {
      T += m ? E.width - E.column.minWidth : E.column.minWidth, E.width = E.column.minWidth;
    }), M = g - T, x = A ? Math.floor(M / A) : M, K = f(z, M, x, m)) : (K = A ? g - Math.floor(g / A) * A : g, z.forEach(function(E) {
      E.width = m ? Ie(E) : Ve(E);
    })), K;
  }
  this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (t -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), l.forEach(function(p) {
    var g, v, m;
    p.visible && (g = p.definition.width, v = parseInt(p.minWidth), g ? (m = c(g), i += m > v ? m : v, p.definition.widthShrink && (a.push({
      column: p,
      width: m > v ? m : v
...
const Z = class Z extends w {
  ...
  initialize() {
    ...
    Z.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("tabulator-layout", this.mode), this.subscribe("column-init", this.initializeColumn.bind(this));
  }
  initializeColumn(e) {
  ...
  layout(e) {
    ...
    this.dispatch("layout-refreshing"), Z.modes[this.mode].call(this, this.table.columnManager.columnsByIndex, e), t && this.table.rowManager.normalizeHeight(!0), this.dispatch("layout-refreshed");
  }
};
b(Z, "moduleName", "layout"), //load defaults
b(Z, "modes", Hs);
let Ae = Z;
var Fs = {
  default: {
...
const ne = class ne extends w {
  ...
  initialize() {
    this.langList = R.deepClone(ne.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
  ...
  setLocale(e) {
    ...
    this.locale = e, this.lang = R.deepClone(this.langList.default || {}), e != "default" && t(this.langList[e], this.lang), this.dispatchExternal("localized", this.locale, this.lang), this._executeBindings();
  }
  //get current locale
  getLocale(e) {
    return this.locale;
...
b(ne, "moduleName", "localize"), //load defaults
b(ne, "langs", Fs);
let Pe = ne;
class pt extends w {
  constructor(e) {
  ...
  lookupTable(e, t) {
    ...
    if (typeof e == "string") {
      if (s = document.querySelectorAll(e), s.length)
        for (var r = 0; r < s.length; r++)
          n = H.registry.matchElement(s[r]), n && i.push(n);
    } else typeof HTMLElement < "u" && e instanceof HTMLElement || e instanceof H ? (n = H.registry.matchElement(e), n && i.push(n)) : Array.isArray(e) ? e.forEach(function(o) {
      i = i.concat(H.registry.lookupTable(o));
    }) : t || console.warn("Table Connection Error - Invalid Selector", e);
    return i;
  },
  matchElement(e) {
    return H.registry.tables.find(function(t) {
      return e instanceof H ? t === e : t.element === e;
    });
  }
});
let Oe = H;
const y = class y extends Oe {
  constructor() {
    super();
  }
  static initializeModuleBinder(e) {
    y.modulesRegistered || (y.modulesRegistered = !0, y._registerModules(As, !0), e && y._registerModules(e));
  }
  static _extendModule(e, t, i) {
    if (y.moduleBindings[e]) {
      var s = y.moduleBindings[e][t];
      if (s)
        if (typeof i == "object")
          for (let n in i)
            s[n] = i[n];
  ...
  static _registerModule(e) {
    Array.isArray(e) || (e = [e]), e.forEach((t) => {
      y._registerModuleBinding(t), y._registerModuleExtensions(t);
    });
  }
  static _registerModuleBinding(e) {
    e.moduleName ? y.moduleBindings[e.moduleName] = e : console.error("Unable to bind module, no moduleName defined", e.moduleName);
  }
  static _registerModuleExtensions(e) {
    ...
    if (e.moduleExtensions)
      for (let i in t) {
        let s = t[i];
        if (y.moduleBindings[i])
          for (let n in s)
            y._extendModule(i, n, s[n]);
        else {
          y.moduleExtensions[i] || (y.moduleExtensions[i] = {});
          for (let n in s)
            y.moduleExtensions[i][n] || (y.moduleExtensions[i][n] = {}), Object.assign(y.moduleExtensions[i][n], s[n]);
        }
      }
    y._extendModuleFromQueue(e);
  }
  static _extendModuleFromQueue(e) {
    var t = y.moduleExtensions[e.moduleName];
    if (t)
      for (let i in t)
        y._extendModule(e.moduleName, i, t[i]);
  }
  //ensure that module are bound to instantiated function
  _bindModules() {
    var e = [], t = [], i = [];
    this.modules = {};
    for (var s in y.moduleBindings) {
      let n = y.moduleBindings[s], r = new n(this);
...
b(y, "moduleBindings", {}), b(y, "moduleExtensions", {}), b(y, "modulesRegistered", !1), b(y, "defaultModules", !1);
let _e = y;
class Ps extends k {
  constructor(e) {
...
const O = class O extends _e {
  ...
  initializeCoreSystems(e) {
    this.columnManager = new bs(this), this.rowManager = new Cs(this), this.footerManager = new Es(this), this.dataLoader = new xs(this), this.alertManager = new Ps(this), this._bindModules(), this.options = this.optionsList.generate(O.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new Ts(this, this.options, this.options.debugEventsExternal), this.eventBus = new Ms(this.options.debugEventsInternal), this.interactionMonitor = new ys(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
  }
...
b(O, "defaultOptions", ps);
let G = O;
class Vs extends G {
  static extendModule() {
    G.initializeModuleBinder(ue), G._extendModule(...arguments);
  }
  static registerModule() {
    G.initializeModuleBinder(ue), G._registerModule(...arguments);
  }
  constructor(e, t, i) {
    super(e, t, ue);
  }
...
export {
  ce as AccessorModule,
  me as AjaxModule,
  Lt as CalcComponent,
  Je as CellComponent,
  ge as ClipboardModule,
  be as ColumnCalcsModule,
  Ke as ColumnComponent,
  Ye as DataTreeModule,
  ve as DownloadModule,
  we as EditModule,
  Ce as ExportModule,
  Ee as FilterModule,
  ye as FormatModule,
  $e as FrozenColumnsModule,
  Qe as FrozenRowsModule,
  Ri as GroupComponent,
  Ze as GroupRowsModule,
  Re as HistoryModule,
  et as HtmlTableImportModule,
  xe as ImportModule,
  tt as InteractionModule,
  Te as KeybindingsModule,
  it as MenuModule,
  w as Module,
  st as MoveColumnsModule,
  Me as MoveRowsModule,
  ke as MutatorModule,
  Le as PageModule,
  Se as PersistenceModule,
  nt as PopupModule,
  rt as PrintModule,
  Is as PseudoRow,
  Ki as RangeComponent,
  ot as ReactiveDataModule,
  he as Renderer,
  at as ResizeColumnsModule,
  lt as ResizeRowsModule,
  ht as ResizeTableModule,
  De as ResponsiveLayoutModule,
  ae as RowComponent,
  oe as SelectRangeModule,
  ze as SelectRowModule,
  dt as SheetComponent,
  He as SortModule,
  ut as SpreadsheetModule,
  G as Tabulator,
  Vs as TabulatorFull,
  ct as TooltipModule,
  Fe as ValidateModule
};
