 ...
 */
const dr = (e) => e instanceof HTMLElement, ur = (e, t = [], n = []) => {
  const r = {
    ...e
  }, s = [], o = [], i = () => ({ ...r }), a = () => {
    const u = [...s];
  ...
  e.setAttribute(t, n);
}, Er = "http://www.w3.org/2000/svg", pr = ["svg", "path"], Mt = (e) => pr.includes(e), He = (e, t, n = {}) => {
  typeof t == "object" && (n = t, t = null);
  const r = Mt(e) ? document.createElementNS(Er, e) : document.createElement(e);
  return t && (Mt(e) ? W(r, "class", t) : r.className = t), V(n, (s, o) => {
    W(r, s, o);
  }), r;
}, Ir = (e) => (t, n) => {
  typeof n < "u" && e.children[n] ? e.insertBefore(t, e.children[n]) : e.appendChild(t);
}, _r = (e, t) => (n, r) => (typeof r < "u" ? t.splice(r, 0, n) : t.push(n), n), Tr = (e, t) => (n) => (t.splice(t.indexOf(n), 1), n.element.parentNode && e.removeChild(n.element), n), mr = typeof window < "u" && typeof window.document < "u", On = () => mr, gr = On() ? He("svg") : {}, Rr = "children" in gr ? (e) => e.children.length : (e) => e.childNodes.length, Dn = (e, t, n, r) => {
  ...
  return t.filter((d) => !d.isRectIgnored()).map((d) => d.rect).forEach((d) => {
    bt(l.inner, { ...d.inner }), bt(l.outer, { ...d.outer });
  }), Ct(l.inner), l.outer.bottom += l.element.marginBottom, l.outer.right += l.element.marginRight, Ct(l.outer), l;
}, bt = (e, t) => {
...
}, Ee = (e) => typeof e == "number", hr = (e, t, n, r = 1e-3) => Math.abs(e - t) < r && Math.abs(n) < r, Or = (
  // default options
  ({ stiffness: e = 0.5, damping: t = 0.75, mass: n = 10 } = {}) => {
    ...
    const d = fe({
      interpolate: (c, f) => {
        ...
        const E = -(s - r) * e;
        o += E / n, s += o, o *= t, hr(s, r, o) || f ? (s = r, o = 0, i = !0, d.onupdate(s), d.oncomplete(s)) : d.onupdate(s);
      },
      target: {
        set: (c) => {
...
), Dr = (e) => e < 0.5 ? 2 * e * e : -1 + (4 - 2 * e) * e, Sr = (
  // default values
  ({ duration: e = 500, easing: t = Dr, delay: n = 0 } = {}) => {
...
}, yr = ({ mixinConfig: e, viewProps: t, viewInternalAPI: n, viewExternalAPI: r }) => {
  const s = { ...t }, o = [];
  return V(e, (i, a) => {
    const l = Ar(a);
    if (!l)
  ...
  const i = [], a = Lr(o.element), l = Pr(o.element);
  return r.on = (d, c) => {
    i.push({
      type: d,
      fn: c
...
}, br = ({ mixinConfig: e, viewProps: t, viewExternalAPI: n }) => {
  It(e, n, t);
}, Q = (e) => e != null, Cr = {
  opacity: 1,
  scaleX: 1,
  ...
  originX: 0,
  originY: 0
}, Nr = ({ mixinConfig: e, viewProps: t, viewInternalAPI: n, viewExternalAPI: r, view: s }) => {
  const o = { ...t }, i = {};
  It(e, [n, r], t);
  ...
  return n.rect = { get: d }, r.rect = { get: d }, e.forEach((c) => {
    t[c] = typeof o[c] > "u" ? Cr[c] : o[c];
  }), {
    write: () => {
      if (vr(i, t))
        return wr(s.element, t), Object.assign(i, { ...t }), !0;
    },
    destroy: () => {
    }
  };
  ...
  let u = "", _ = "";
  (Q(c) || Q(f)) && (_ += `transform-origin: ${c || 0}px ${f || 0}px;`), Q(n) && (u += `perspective(${n}px) `), (Q(r) || Q(s)) && (u += `translate3d(${r || 0}px, ${s || 0}px, 0) `), (Q(o) || Q(i)) && (u += `scale3d(${Q(o) ? o : 1}, ${Q(i) ? i : 1}, 1) `), Q(d) && (u += `rotateZ(${d}rad) `), Q(a) && (u += `rotateX(${a}rad) `), Q(l) && (u += `rotateY(${l}rad) `), u.length && (_ += `transform:${u};`), Q(t) && (_ += `opacity:${t};`, t === 0 && (_ += "visibility:hidden;"), t < 1 && (_ += "pointer-events:none;")), Q(T) && (_ += `height:${T}px;`), Q(E) && (_ += `width:${E}px;`);
  ...
  ({
    ...
    const _ = He(e, `filepond--${t}`, n), D = window.getComputedStyle(_, null), R = vt();
    let O = null, L = !1;
    const P = [], S = [], N = {}, B = {}, h = [
      s
      // default writer
      ...
      O = null, P.forEach((le) => le._read()), !(f && R.width && R.height) && vt(R, _, D);
      ...
      appendChildView: _r(_, P),
      removeChildView: Tr(_, P),
      registerWriter: (G) => h.push(G),
      registerReader: (G) => b.push(G),
...
}, wt = (e, t) => t.parentNode.insertBefore(e, t), Gt = (e, t) => t.parentNode.insertBefore(e, t.nextSibling), ze = (e) => Array.isArray(e), ae = (e) => e == null, Ur = (e) => e.trim(), Xe = (e) => "" + e, Br = (e, t = ",") => ae(e) ? [] : ze(e) ? e : Xe(e).split(t).map(Ur).filter((n) => n.length), Sn = (e) => typeof e == "boolean", An = (e) => Sn(e) ? e : e === "true", j = (e) => typeof e == "string", yn = (e) => Ee(e) ? e : j(e) ? Xe(e).replace(/[a-z]+/gi, "") : 0, xe = (e) => parseInt(yn(e), 10), Ft = (e) => parseFloat(yn(e)), Le = (e) => Ee(e) && isFinite(e) && Math.floor(e) === e, Ut = (e, t = 1e3) => {
  if (Le(e))
    return e;
  let n = Xe(e).trim();
  return /MB$/i.test(n) ? (n = n.replace(/MB$i/, "").trim(), xe(n) * t * t) : /KB/i.test(n) ? (n = n.replace(/KB$i/, "").trim(), xe(n) * t) : xe(n);
}, pe = (e) => typeof e == "function", Vr = (e) => {
  ...
  const t = {};
  return t.url = j(e) ? e : e.url || "", t.timeout = e.timeout ? parseInt(e.timeout, 10) : 0, t.headers = e.headers ? e.headers : {}, V(Bt, (n) => {
    t[n] = xr(n, e[n], Bt[n], t.timeout, t.headers);
...
}, Hr = (e) => qr(e), Yr = (e) => e === null, z = (e) => typeof e == "object" && e !== null, $r = (e) => z(e) && j(e.url) && z(e.process) && z(e.revert) && z(e.restore) && z(e.fetch), lt = (e) => ze(e) ? "array" : Yr(e) ? "null" : Le(e) ? "int" : /^[0-9]+ ?(?:GB|MB|KB)$/gi.test(e) ? "bytes" : $r(e) ? "api" : typeof e, Wr = (e) => e.replace(/{\s*'/g, '{"').replace(/'\s*}/g, '"}').replace(/'\s*:/g, '":').replace(/:\s*'/g, ':"').replace(/,\s*'/g, ',"').replace(/'\s*,/g, '",'), zr = {
  array: Br,
  boolean: An,
  int: (e) => lt(e) === "bytes" ? Ut(e) : xe(e),
  number: Ft,
  float: Ft,
  bytes: Ut,
  string: (e) => pe(e) ? e : Xe(e),
  function: (e) => Vr(e),
  serverapi: Hr,
  object: (e) => {
    try {
      return JSON.parse(Wr(e));
    } catch {
      return null;
    }
  }
}, Xr = (e, t) => zr[t](e), Ln = (e, t, n) => {
  if (e === t)
    return e;
  let r = lt(e);
  if (r !== n) {
  ...
  // options
  options: Qr(e)
}), ke = (e, t = "-") => e.split(/(?=[A-Z])/).map((n) => n.toLowerCase()).join(t), Kr = (e, t) => {
  const n = {};
  return V(t, (r) => {
    n[r] = {
      get: () => e.getState().options[r],
      set: (s) => {
        e.dispatch(`SET_${ke(r, "_").toUpperCase()}`, {
          value: s
        });
      }
    };
  ...
  const n = {};
  return V(e, (r) => {
    n[`GET_${ke(r, "_").toUpperCase()}`] = (s) => t.options[r];
  }), n;
}, re = {
  API: 1,
  DROP: 2,
  ...
  PASTE: 4,
  NONE: 5
}, _t = () => Math.random().toString(36).substring(2, 11), Tt = (e, t) => e.splice(t, 1), es = (e, t) => {
  ...
  const e = [], t = (r, s) => {
    ...
    e.filter((i) => i.event === r).map((i) => i.cb).forEach((i) => es(() => i(...s), o));
  };
  return {
    fireSync: (r, ...s) => {
      n(r, s, !0);
  ...
  LIMBO: 2,
  LOCAL: 3
}, Mn = (e) => /[^0-9]+/.exec(e), bn = () => Mn(1.1.toLocaleString())[0], rs = () => {
  const e = bn(), t = 1e3.toLocaleString();
  ...
  REGEX: "regex"
}, mt = [], se = (e, t, n) => new Promise((r, s) => {
  const o = mt.filter((a) => a.key === e).map((a) => a.cb);
  if (o.length === 0) {
    r(t);
    return;
  }
...
}), Re = (e, t, n) => mt.filter((r) => r.key === e).map((r) => r.cb(t, n)), ss = (e, t) => mt.push({ key: e, cb: t }), is = (e) => Object.assign(De, e), Ye = () => ({ ...De }), os = (e) => {
  V(e, (t, n) => {
    De[t] && (De[t][0] = Ln(
      n,
      De[t][0],
  ...
  labelDecimalSeparator: [bn(), p.STRING],
  // Default is locale separator
  labelThousandsSeparator: [rs(), p.STRING],
  // Default is locale separator
  labelIdle: [
  ...
  credits: [["https://filepond.com", "Powered by FilePond"], p.ARRAY]
...
const ls = () => {
  ...
  C.PROCESSING_QUEUED,
  C.INIT
], ds = [C.PROCESSING_COMPLETE], us = (e) => as.includes(e.status), fs = (e) => cs.includes(e.status), Es = (e) => ds.includes(e.status), Vt = (e) => z(e.options.server) && (z(e.options.server.process) || pe(e.options.server.process)), ps = (e) => ({
  GET_STATUS: () => {
    const t = ie(e.items), { EMPTY: n, ERROR: r, BUSY: s, IDLE: o, READY: i } = Nn;
    return t.length === 0 ? n : t.some(us) ? r : t.some(fs) ? s : t.some(Es) ? i : o;
  },
  ...
  SHOULD_UPDATE_FILE_INPUT: () => e.options.storeAsFile && ls() && !Vt(e),
  IS_ASYNC: () => Vt(e),
  ...
  return n === null || t < n;
}, vn = (e, t, n) => Math.max(Math.min(n, e), t), _s = (e, t, n) => e.splice(t, 0, n), Ts = (e, t, n) => ae(t) ? null : typeof n > "u" ? (e.push(t), t) : (n = vn(n, 0, e.length), _s(e, n, t), t), at = (e) => /^\s*data:([a-z]+\/[a-z0-9-+.]+(;[a-z-]+=[a-z0-9-]+)?)?(;base64)?,([a-z0-9!$&',()*+;=\-._~:@\/?%\s]*)\s*$/i.test(
  e
), Ne = (e) => `${e}`.split("/").pop().split("?").shift(), je = (e) => e.split(".").pop(), ms = (e) => {
  if (typeof e != "string")
    return "";
  const t = e.split("/").pop();
  ...
  return s.lastModifiedDate = /* @__PURE__ */ new Date(), e._relativePath && (s._relativePath = e._relativePath), j(t) || (t = wn()), t && r === null && je(t) ? s.name = t : (r = r || ms(s.type), s.name = t + (r ? "." + r : "")), s;
}, gs = () => window.BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, Gn = (e, t) => {
  const n = gs();
  if (n) {
    const r = new n();
  ...
  for (let s = 0; s < e.length; s++)
    r[s] = e.charCodeAt(s);
  return Gn(n, t);
}, Fn = (e) => (/^data:(.+);/.exec(e) || [])[1] || null, hs = (e) => e.split(",")[1].replace(/\s/g, ""), Os = (e) => atob(hs(e)), Ds = (e) => {
  const t = Fn(e), n = Os(e);
  return Rs(n, t);
}, Ss = (e, t, n) => ye(Ds(e), t, null, n), As = (e) => {
  ...
  return null;
}, Ls = (e) => /x-content-transfer-id:/i.test(e) && (e.split(":")[1] || "").trim() || null, gt = (e) => {
  const t = {
    source: null,
    name: null,
    size: null
...
`);
  ...
  const t = {
    ...
    const a = t.source;
    i.fire("init", a), a instanceof File ? i.fire("load", a) : a instanceof Blob ? i.fire("load", ye(a, a.name)) : at(a) ? i.fire("load", Ss(a)) : o(a);
  }, o = (a) => {
    if (!e) {
      i.fire("error", {
        type: "error",
  ...
  n = {
    ...
    withCredentials: !1,
    ...n
  }, t = encodeURI(t), qt(n.method) && e && (t = `${t}${encodeURIComponent(typeof e == "string" ? e : JSON.stringify(e))}`);
  const i = new XMLHttpRequest(), a = qt(n.method) ? i : i.upload;
  ...
  return (s, o, i, a, l, d) => {
    ...
    return c.onload = (f) => {
      const E = f.getAllResponseHeaders(), T = gt(E).name || Ne(s);
      o(
        q(
          "load",
          f.status,
  ...
  const f = [], { chunkTransferId: E, chunkServer: T, chunkSize: u, chunkRetryDelays: _ } = c, D = {
    ...
    y.onload = (M) => m(O(M, g.method)), y.onerror = (M) => i(
      q(
        "error",
        M.status,
        L(M.response) || M.statusText,
  ...
  const B = () => o(D.serverId), h = (m) => m.status === te.QUEUED || m.status === te.ERROR, b = (m) => {
    if (D.aborted) return;
    if (m = m || f.find(h), !m) {
    ...
    }), y = Ce(e, T.url, D.serverId), M = typeof T.headers == "function" ? T.headers(m) : {
      ...T.headers,
    ...
    f.filter((U) => U.status === te.PROCESSING).length >= 1 || b();
  }, X = () => {
    f.forEach((m) => {
...
}, Cs = (e = "", t, n, r) => typeof t == "function" ? (...s) => t(n, ...s, r) : !t || !j(t.url) ? null : bs(e, t, n, r), Me = (e = "", t) => {
  if (typeof t == "function")
    return t;
  if (!t || !j(t.url))
    return (s, o) => o();
...
}, Un = (e = 0, t = 1) => e + Math.random() * (t - e), Ns = (e, t = 1e3, n = 0, r = 25, s = 250) => {
  let o = null;
  const i = Date.now(), a = () => {
  ...
  const n = {
    ...
    d.fire("start"), n.timestamp = Date.now(), n.perceivedPerformanceUpdater = Ns(
      (u) => {
  ...
  return d;
}, Bn = (e) => e.substring(0, e.lastIndexOf(".")) || e, ws = (e) => {
  let t = [e.name, e.size, e.type];
  return e instanceof Blob || at(e) ? t[0] = e.name || wn() : at(e) ? (t[1] = e.length, t[2] = Fn(e)) : j(e) && (t[0] = Ne(e), t[1] = 0, t[2] = "application/octet-stream"), {
    name: t[0],
    size: t[1],
    type: t[2]
  };
  ...
  let o = null;
  const i = {}, a = (h) => s.status = h, l = (h, ...b) => {
    s.released || s.frozen || N.fire(h, ...b);
  }, d = () => je(s.file.name), c = () => s.file.type, f = () => s.file.size, E = () => s.file, T = (h, b, F) => {
    if (s.source = h, N.fireSync("init"), s.file) {
      N.fireSync("load-skip");
      return;
    }
    s.file = ws(h), b.on("init", () => {
      l("load-init");
    }), b.on("meta", (A) => {
      ...
      F(A, v, X);
    }), b.setSource(h), s.activeLoader = b, b.load();
  }, u = () => {
    ...
    b(s.file, F, A), s.activeProcessor = h;
  }, R = () => {
    ...
    let m = i;
    A.forEach((U) => m = m[U]), JSON.stringify(m[X]) !== JSON.stringify(b) && (m[X] = b, l("metadata-update", {
      key: v,
      value: i[v],
      silent: F
    }));
  ...
  return B;
}, Fs = (e, t) => ae(t) ? 0 : j(t) ? e.findIndex((n) => n.id === t) : -1, Ht = (e, t) => {
  const n = Fs(e, t);
  if (!(n < 0))
    return e[n] || null;
}, Yt = (e, t, n, r, s, o) => {
  ...
  return i.onload = (a) => {
    const l = a.getAllResponseHeaders(), d = gt(l).name || Ne(e);
...
}, $t = (e) => (e.indexOf("//") === 0 && (e = location.protocol + e), e.toLowerCase().replace("blob:", "").replace(/([a-z])?:\/\//, "$1").split("/")[0]), Us = (e) => (e.indexOf(":") > -1 || e.indexOf("//") > -1) && $t(location.href) !== $t(e), Fe = (e) => (...t) => pe(e) ? e(...t) : e, Bs = (e) => !me(e.file), et = (e, t) => {
  clearTimeout(t.listUpdateTimeout), t.listUpdateTimeout = setTimeout(() => {
    e("DID_UPDATE_ITEMS", { items: ie(t.items) });
  }, 0);
}, Wt = (e, ...t) => new Promise((n) => {
  if (!e)
    return n(!0);
  const r = e(...t);
  if (r == null)
  ...
  DID_UPDATE_ITEM_METADATA: ({ id: r, action: s, change: o }) => {
    o.silent || (clearTimeout(n.itemUpdateTimeout), n.itemUpdateTimeout = setTimeout(() => {
      ...
      const a = () => {
        ...
        i.revert(
          Me(n.options.server.url, n.options.server.revert),
          t("GET_FORCE_REVERT")
        ).then(c ? a : () => {
        }).catch(() => {
        });
  ...
  ADD_ITEM: ({
    ...
    const d = l.type === "local" ? $.LOCAL : l.type === "limbo" ? $.LIMBO : $.INPUT, c = Gs(
    ...
    n.options.itemInsertLocationFreedom || (s = f === "before" ? -1 : n.items.length), Ts(n.items, c, s), pe(f) && r && tt(n, f);
    const E = c.id;
    c.on("init", () => {
      ...
      se("DID_LOAD_ITEM", c, { query: t, dispatch: e }).then(() => {
        Wt(t("GET_BEFORE_ADD_FILE"), J(c)).then(
          R
        );
      }).catch((O) => {
    ...
    }), e("DID_ADD_ITEM", { id: E, index: s, interactionMethod: o }), et(e, n);
    ...
    c.load(
      ...
      Ps(
        d === $.INPUT ? (
          ...
          j(r) && Us(r) && D ? Je(T, D) : Yt
        ) : (
          // limbo or local
          d === $.LIMBO ? Je(T, _) : Je(T, u)
        )
        // local
      ),
  ...
  COMPLETE_LOAD_ITEM: ({ item: r, data: s }) => {
    ...
    if (pe(a) && i && tt(n, a), e("DID_LOAD_ITEM", {
      id: r.id,
      error: null,
  ...
  PROCESS_ITEM: ne(n, (r, s, o) => {
    ...
    }), r.onOnce("process-abort", () => {
      l();
    });
    const d = n.options;
    r.process(
      vs(
        Cs(d.server.url, d.server.process, d.name, {
  ...
  REQUEST_REMOVE_ITEM: ne(n, (r) => {
    Wt(t("GET_BEFORE_REMOVE_FILE"), J(r)).then((s) => {
  ...
  REMOVE_ITEM: ne(n, (r, s, o, i) => {
    const a = () => {
      const d = r.id;
      Ht(n.items, d).archive(), e("DID_REMOVE_ITEM", { error: null, id: d, item: r }), et(e, n), s(J(r));
    }, l = n.options.server;
  ...
  REVERT_ITEM_PROCESSING: ne(n, (r) => {
    r.revert(
      ...
      (n.options.instantUpload || Bs(r)) && e("REMOVE_ITEM", { query: r.id });
    }).catch(() => {
    });
  }),
  SET_OPTIONS: ({ options: r }) => {
    const s = Object.keys(r), o = qs.filter((a) => s.includes(a));
    [
...
], Rt = (e) => e, ce = (e) => document.createElement(e), x = (e, t) => {
  ...
  const i = zt(e, t, n, s), a = zt(e, t, n, r);
  return ["M", i.x, i.y, "A", n, n, 0, o, 0, a.x, a.y].join(" ");
}, Hs = (e, t, n, r, s) => {
  let o = 1;
  return s > r && s - r <= 0.5 && (o = 0), r > s && r - s >= 0.5 && (o = 0), xs(
    e,
    t,
    n,
  ...
  return e < l ? `${e} ${s}` : e < d ? `${Math.floor(e / l)} ${o}` : e < c ? `${kt(e / d, 1, t)} ${i}` : `${kt(e / c, 2, t)} ${a}`;
}, kt = (e, t, n) => e.toFixed(t).split(".").filter((r) => r !== "0").join(n), Xs = ({ root: e, props: t }) => {
  const n = ce("span");
  n.className = "filepond--file-info-main", W(n, "aria-hidden", "true"), e.appendChild(n), e.ref.fileName = n;
  const r = ce("span");
  r.className = "filepond--file-info-sub", e.appendChild(r), e.ref.fileSize = r, x(r, e.query("GET_LABEL_FILE_WAITING_FOR_SIZE")), x(n, Rt(e.query("GET_ITEM_NAME", t.id)));
}, ct = ({ root: e, props: t }) => {
  x(
    e.ref.fileSize,
    xn(
  ...
  ), x(e.ref.fileName, Rt(e.query("GET_ITEM_NAME", t.id)));
}, Qt = ({ root: e, props: t }) => {
...
}), Hn = (e) => Math.round(e * 100), Qs = ({ root: e }) => {
  const t = ce("span");
  ...
  write: K({
    ...
    DID_REQUEST_ITEM_PROCESSING: Ks,
...
const ee = (e) => {
...
}, ti = (e) => e.ref.buttonAbortItemLoad.rect.element.width, Ue = (e) => Math.floor(e.ref.buttonRemoveItem.rect.element.height / 4), ni = (e) => Math.floor(e.ref.buttonRemoveItem.rect.element.left / 2), ri = (e) => e.query("GET_STYLE_LOAD_INDICATOR_POSITION"), si = (e) => e.query("GET_STYLE_PROGRESS_INDICATOR_POSITION"), ft = (e) => e.query("GET_STYLE_BUTTON_REMOVE_ITEM_POSITION"), ii = {
  ...
  loadProgressIndicator: { opacity: 0, align: ri },
  processProgressIndicator: { opacity: 0, align: si },
  ...
  DID_START_ITEM_PROCESSING: nt,
  DID_REQUEST_ITEM_PROCESSING: nt,
  DID_UPDATE_ITEM_PROCESS_PROGRESS: nt,
  ...
  if (a && s && (n.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", n.RevertItemProcessing.icon = "GET_ICON_REMOVE"), l && !s) {
    ...
    u.info.translateX = ni, u.info.translateY = Ue, u.status.translateY = Ue, u.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 };
  }
  if (l && !i && ([
  ...
  }), Se.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = ti), d && s) {
  ...
  o || (n.RemoveItem.disabled = !0), V(n, (u, _) => {
    ...
    e.createChildView(oi)
  ), e.ref.processingCompleteIndicator.element.dataset.align = e.query(
    "GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"
  ), e.ref.info = e.appendChildView(e.createChildView(ks, { id: r })), e.ref.status = e.appendChildView(e.createChildView(ei, { id: r }));
  const E = e.appendChildView(
    e.createChildView(Xt, {
      opacity: 0,
...
}, ai = ({ root: e, actions: t, props: n }) => {
  ci({ root: e, actions: t, props: n });
  ...
  e.ref.fileName = ce("legend"), e.appendChild(e.ref.fileName), e.ref.file = e.appendChildView(e.createChildView(di, { id: t.id })), e.ref.data = !1;
}, fi = ({ root: e, props: t }) => {
  x(e.ref.fileName, Rt(e.query("GET_ITEM_NAME", t.id)));
}, Ei = H({
  create: ui,
  ...
  tag: "fieldset",
  name: "file-wrapper"
}), Zt = { type: "spring", damping: 0.6, mass: 7 }, pi = ({ root: e, props: t }) => {
  [
    {
      name: "top"
    },
  ...
  const n = (r) => {
    ...
    const i = Ti(e.query("GET_ACTIVE_ITEMS"));
  ...
  ({ root: e, actions: t, props: n, shouldOptimize: r }) => {
    ...
    let s = t.concat().filter((i) => /^DID_/.test(i.type)).reverse().find((i) => tn[i.type]);
    s && s.type !== n.currentState && (n.currentState = s.type, e.element.dataset.filepondItemState = tn[n.currentState] || "");
    const o = e.query("GET_ITEM_PANEL_ASPECT_RATIO") || e.query("GET_PANEL_ASPECT_RATIO");
    o ? r || (e.height = e.rect.element.width * o) : (gi({ root: e, actions: t, props: n }), !e.height && e.ref.container.rect.element.height > 0 && (e.height = e.ref.container.rect.element.height)), r && (e.ref.panel.height = null), e.ref.panel.height = e.height;
  }
), hi = H({
  create: mi,
  write: Ri,
...
var ht = (e, t) => Math.max(1, Math.floor((e + 1) / t));
const Ot = (e, t, n) => {
  if (!n) return;
  const r = e.rect.element.width, s = t.length;
  let o = null;
  if (s === 0 || n.top < t[0].rect.element.top) return -1;
  const a = t[0].rect.element, l = a.marginLeft + a.marginRight, d = a.width + l, c = ht(r, d);
  if (c === 1) {
    for (let T = 0; T < s; T++) {
  ...
  e.dragOffset ? (e.translateX = null, e.translateY = null, e.translateX = e.dragOrigin.x + e.dragOffset.x, e.translateY = e.dragOrigin.y + e.dragOffset.y, e.scaleX = 1.025, e.scaleY = 1.025) : (e.translateX = t, e.translateY = n, Date.now() > e.spawnDate && (e.opacity === 0 && Si(e, t, n, r, s), e.scaleX = 1, e.scaleY = 1, e.opacity = 1));
}, Si = (e, t, n, r, s) => {
...
}, rt = (e) => e.rect.element.height + e.rect.element.marginBottom + e.rect.element.marginTop, yi = (e) => e.rect.element.width + e.rect.element.marginLeft * 0.5 + e.rect.element.marginRight * 0.5, Li = ({ root: e, action: t }) => {
  ...
  var T = {
    ...
    getColIndex: function() {
      ...
      ), P = L.findIndex((A) => A === o), S = rt(o), N = L.length;
      let B = N, h = 0, b = 0, F = 0;
      for (let A = 0; A < N; A++)
        if (h = rt(L[A]), F = b, b = F + h, l.y < b) {
          if (P > A) {
            if (l.y < F + S) {
              B = A;
              break;
  ...
  DID_REMOVE_ITEM: Ai,
  DID_DRAG_ITEM: Li
}), Mi = ({ root: e, props: t, actions: n, shouldOptimize: r }) => {
  Pi({ root: e, props: t, actions: n });
  const { dragCoordinates: s } = t, o = e.rect.element.width, i = e.childViews.filter((L) => L.rect.element.height), a = e.query("GET_ACTIVE_ITEMS").map((L) => i.find((P) => P.id === L.id)).filter((L) => L), l = s ? Ot(e, a, s) : null, d = e.ref.addIndex || null;
  e.ref.addIndex = null;
  let c = 0, f = 0, E = 0;
  if (a.length === 0) return;
  const T = a[0].rect.element, u = T.marginTop + T.marginBottom, _ = T.marginLeft + T.marginRight, D = T.width + _, R = T.height + u, O = ht(o, D);
  if (O === 1) {
    let L = 0, P = 0;
    a.forEach((S, N) => {
      if (l) {
        let b = N - l;
        b === -2 ? P = -u * 0.25 : b === -1 ? P = -u * 0.75 : b === 0 ? P = u * 0.75 : b === 1 ? P = u * 0.25 : P = 0;
      }
      r && (S.translateX = null, S.translateY = null), S.markedForRemoval || nn(S, 0, L + P);
    ...
    a.forEach((S, N) => {
      ...
      const B = N + E + c + f, h = B % O, b = Math.floor(B / O), F = h * D, A = b * R, v = Math.sign(F - L), X = Math.sign(A - P);
      L = F, P = A, !S.markedForRemoval && (r && (S.translateX = null, S.translateY = null), nn(S, F, A, v, X));
    });
  }
}, bi = (e, t) => t.filter((n) => n.data && n.data.id ? e.id === n.data.id : !0), Ci = H({
  create: Oi,
  write: Mi,
  tag: "ul",
  name: "list",
  ...
  filterFrameActionsForChild: bi,
  mixins: {
    apis: ["dragCoordinates"]
  }
}), Ni = ({ root: e, props: t }) => {
  e.ref.list = e.appendChildView(e.createChildView(Ci)), t.dragCoordinates = null, t.overflowing = !1;
}, vi = ({ root: e, props: t, action: n }) => {
  ...
  DID_DRAG: vi,
  DID_END_DRAG: wi
}), Fi = ({ root: e, props: t, actions: n }) => {
  if (Gi({ root: e, props: t, actions: n }), e.ref.list.dragCoordinates = t.dragCoordinates, t.overflowing && !t.overflow && (t.overflowing = !1, e.element.dataset.state = "", e.height = null), t.overflow) {
  ...
  e.element.id = `filepond--browser-${t.id}`, W(e.element, "name", e.query("GET_NAME")), W(e.element, "aria-controls", `filepond--assistant-${t.id}`), W(e.element, "aria-labelledby", `filepond--drop-label-${t.id}`), Wn({ root: e, action: { value: e.query("GET_ACCEPTED_FILE_TYPES") } }), zn({ root: e, action: { value: e.query("GET_ALLOW_MULTIPLE") } }), Xn({ root: e, action: { value: e.query("GET_ALLOW_DIRECTORIES_ONLY") } }), Et({ root: e }), kn({ root: e, action: { value: e.query("GET_REQUIRED") } }), Qn({ root: e, action: { value: e.query("GET_CAPTURE_METHOD") } }), e.ref.handleChange = (n) => {
    if (!e.element.value)
      return;
    const r = Array.from(e.element.files).map((s) => (s._relativePath = s.webkitRelativePath, s));
    setTimeout(() => {
      t.onload(r), Bi(e.element);
    }, 250);
  ...
  W(n, "for", `filepond--browser-${t.id}`), W(n, "id", `filepond--drop-label-${t.id}`), e.ref.handleKeyDown = (r) => {
    (r.keyCode === sn.ENTER || r.keyCode === sn.SPACE) && (r.preventDefault(), e.ref.label.click());
  }, e.ref.handleClick = (r) => {
  ...
  const n = Ke(e, t.id);
  n && (t.value === null ? n.removeAttribute("value") : n.type != "file" && (n.value = t.value), Dt(e));
}, io = K({
  DID_SET_DISABLED: no,
  DID_ADD_ITEM: Ji,
  DID_LOAD_ITEM: eo,
  DID_REMOVE_ITEM: ro,
  DID_DEFINE_VALUE: so,
  DID_PREPARE_OUTPUT: to,
  DID_REORDER_ITEMS: on,
  DID_SORT_ITEMS: on
}), oo = H({
  tag: "fieldset",
  name: "data",
  ...
  write: io,
  ignoreRect: !0
}), lo = (e) => "getRootNode" in e ? e.getRootNode() : document, ao = ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg", "tiff"], co = ["css", "csv", "html", "txt"], uo = {
  zip: "zip|compressed",
  epub: "application/epub+zip"
}, Zn = (e = "") => (e = e.toLowerCase(), ao.includes(e) ? "image/" + (e === "jpg" ? "jpeg" : e === "svg" ? "svg+xml" : e) : co.includes(e) ? "text/" + e : uo[e] || ""), St = (e) => new Promise((t, n) => {
  const r = go(e);
  if (r.length && !fo(e))
    return t(r);
  Eo(e).then(t);
}), fo = (e) => e.files ? e.files.length > 0 : !1, Eo = (e) => new Promise((t, n) => {
  const r = (e.items ? Array.from(e.items) : []).filter((s) => po(s)).map((s) => Io(s));
  if (!r.length) {
  ...
  return e.kind === "file";
}, Io = (e) => new Promise((t, n) => {
  if (mo(e)) {
    _o(At(e)).then(t).catch(n);
    return;
  }
  t([e.getAsFile()]);
  ...
  const t = e.lastModifiedDate, n = e.name, r = Zn(je(e.name));
  return r.length && (e = e.slice(0, e.size, r), e.name = n, e.lastModifiedDate = t), e;
}, mo = (e) => Jn(e) && (At(e) || {}).isDirectory, Jn = (e) => "webkitGetAsEntry" in e, At = (e) => e.webkitGetAsEntry(), go = (e) => {
  let t = [];
  try {
    if (t = ho(e), t.length)
      return t;
  ...
  const s = {
    ...
    addListener: (o) => (t.push(o), () => {
      t.splice(t.indexOf(o), 1), t.length === 0 && ($e.splice($e.indexOf(s), 1), V(n, (i) => {
        e.removeEventListener(i, r[i], !1);
      }));
    })
  };
  return s;
}, Ao = (e, t) => ("elementFromPoint" in e || (e = document), e.elementFromPoint(t.x, t.y)), yt = (e, t) => {
  const n = lo(t), r = Ao(n, {
...
const Ve = (e, t) => {
  ...
  const { catchesDropsOnPage: r, requiresDropOnElement: s, filterItems: o = (c) => c } = n, i = Oo(
    e,
...
const Ae = [], tr = (e) => {
  ...
  St(e.clipboardData).then((r) => {
    r.length && Ae.forEach((s) => s(r));
  });
}, Co = (e) => {
  Ae.includes(e) || (Ae.push(e), !pt && (pt = !0, document.addEventListener("paste", tr)));
}, No = (e) => {
  Tt(Ae, Ae.indexOf(e)), Ae.length === 0 && (document.removeEventListener("paste", tr), pt = !1);
}, vo = () => {
  const e = (n) => {
    t.onload(n);
  }, t = {
...
const st = [], Ze = (e, t) => {
...
}, rr = (e) => e.element.parentNode.contains(document.activeElement), Fo = ({ root: e, action: t }) => {
  if (!rr(e))
    return;
  e.element.textContent = "";
  const n = e.query("GET_ITEM", t.id);
  st.push(n.filename), clearTimeout(ln), ln = setTimeout(() => {
    nr(e, st.join(", "), e.query("GET_LABEL_FILE_ADDED")), st.length = 0;
  }, 750);
}, Uo = ({ root: e, action: t }) => {
  if (!rr(e))
    return;
  ...
  Ze(e, `${t.status.main} ${r} ${t.status.sub}`);
}, Vo = H({
  create: wo,
  ignoreRect: !0,
  ignoreRectUpdate: !0,
  write: K({
    DID_LOAD_ITEM: Fo,
    DID_REMOVE_ITEM: Uo,
    DID_COMPLETE_ITEM_PROCESSING: Bo,
    DID_ABORT_ITEM_PROCESSING: cn,
    DID_REVERT_ITEM_PROCESSING: cn,
...
}, qo = 1e6, We = (e) => e.preventDefault(), xo = ({ root: e, props: t }) => {
  ...
  r && r.split(" ").filter((l) => l.length).forEach((l) => {
    ...
    e.createChildView(Yi, {
      ...t,
      translateY: null,
      caption: e.query("GET_LABEL_IDLE")
    })
  ), e.ref.list = e.appendChildView(e.createChildView(Ui, { translateY: null })), e.ref.panel = e.appendChildView(e.createChildView($n, { name: "panel-root" })), e.ref.assistant = e.appendChildView(e.createChildView(Vo, { ...t })), e.ref.data = e.appendChildView(e.createChildView(oo, { ...t })), e.ref.measure = ce("div"), e.ref.measure.style.height = "100%", e.element.appendChild(e.ref.measure), e.ref.bounds = null, e.query("GET_STYLES").filter((l) => !ae(l.value)).map(({ name: l, value: d }) => {
  ...
  e.query("GET_ALLOW_REORDER") && o && !s && (e.element.addEventListener("touchmove", We, { passive: !1 }), e.element.addEventListener("gesturestart", We));
...
}, Ho = ({ root: e, props: t, actions: n }) => {
  if (Xo({ root: e, props: t, actions: n }), n.filter((N) => /^DID_SET_STYLE_/.test(N.type)).filter((N) => !ae(N.data.value)).map(({ type: N, data: B }) => {
  ...
  let r = e.ref.bounds;
  r || (r = e.ref.bounds = Wo(e), e.element.removeChild(e.ref.measure), e.ref.measure = null);
  const { hopper: s, label: o, list: i, panel: a } = e.ref;
  s && s.updateHopperState();
  const l = e.query("GET_PANEL_ASPECT_RATIO"), d = e.query("GET_ALLOW_MULTIPLE"), c = e.query("GET_TOTAL_ITEMS"), f = d ? e.query("GET_MAX_FILES") || qo : 1, E = c === f, T = n.find((N) => N.type === "DID_ADD_ITEM");
  if (E && T) {
  ...
  const u = Yo(e), _ = $o(e), D = o.rect.element.height, R = !d || E ? 0 : D, O = E ? i.rect.element.marginTop : 0, L = c === 0 ? 0 : i.rect.element.marginBottom, P = R + O + _.visual + L, S = R + O + _.bounds + L;
  ...
  const a = s.rect.element.width, l = Ot(s, i, r.dragCoordinates), d = i[0].rect.element, c = d.marginTop + d.marginBottom, f = d.marginLeft + d.marginRight, E = d.width + f, T = d.height + c, u = typeof l < "u" && l >= 0 ? 1 : 0, _ = i.find((O) => O.markedForRemoval && O.opacity < 0.45) ? -1 : 0, D = i.length + u + _, R = ht(a, E);
  ...
  if (r && !e.ref.hopper) {
    ...
    }, e.ref.hopper = s, e.ref.drip = e.appendChildView(e.createChildView(Ki));
  ...
  r && !e.ref.paster ? (e.ref.paster = vo(), e.ref.paster.onload = (s) => {
  ...
  DID_SET_DISABLED: ({ root: e, props: t }) => {
    dn(e), fn(e), un(e, t), e.query("GET_DISABLED") ? e.element.dataset.disabled = "disabled" : e.element.removeAttribute("data-disabled");
  }
}), ko = H({
  name: "root",
  read: ({ root: e }) => {
  ...
  write: Ho,
  destroy: ({ root: e }) => {
    e.ref.paster && e.ref.paster.destroy(), e.ref.hopper && e.ref.hopper.destroy(), e.element.removeEventListener("touchmove", We), e.element.removeEventListener("gesturestart", We);
  },
  mixins: {
    styles: ["height"]
  }
  ...
  const u = {
    ...
    _write: (I) => {
      ...
      E && !g.length || (O(g), E = f._write(I, g, a), ns(r.query("GET_ITEMS")), E && r.processDispatchQueue());
    }
  }, _ = (I) => (g) => {
    const y = {
      type: I
    ...
    if (g.hasOwnProperty("error") && (y.error = g.error ? { ...g.error } : null), g.status && (y.status = { ...g.status }), g.file && (y.output = g.file), g.source)
      ...
      const M = g.item ? g.item : r.query("GET_ITEM", g.id);
      y.file = M ? J(M) : null;
    }
    ...
    Object.keys(I).filter((w) => !M.includes(w)).forEach((w) => y.push(I[w])), U.fire(I.type, ...y);
    const Y = r.query(`GET_ON${I.type.toUpperCase()}`);
    Y && Y(...y);
  }, O = (I) => {
    I.length && I.filter((g) => D[g.type]).forEach((g) => {
      const y = D[g.type];
      (Array.isArray(y) ? y : [y]).forEach((M) => {
        g.type === "DID_INIT_ITEM" ? R(M(g.data)) : setTimeout(() => {
          R(M(g.data));
        }, 0);
      });
    });
  ...
  }), N = (I, g = {}) => new Promise((y, M) => {
    b([{ source: I, options: g }], { index: g.index }).then((Y) => y(Y && Y[0])).catch(M);
  }), B = (I) => I.file && I.id, h = (I, g) => (typeof I == "object" && !B(I) && !g && (g = I, I = void 0), r.dispatch("REMOVE_ITEM", { ...g, query: I }), r.query("GET_ACTIVE_ITEM", I) === null), b = (...I) => new Promise((g, y) => {
    const M = [], Y = {};
    if (ze(I[0]))
      M.push.apply(M, I[0]), Object.assign(Y, I[1] || {});
    else {
      const w = I[I.length - 1];
      typeof w == "object" && !(w instanceof Blob) && Object.assign(Y, I.pop()), M.push(...I);
    }
    ...
    if (!g.length) {
      const y = F().filter(
        (M) => !(M.status === C.IDLE && M.origin === $.LOCAL) && M.status !== C.PROCESSING && M.status !== C.PROCESSING_COMPLETE && M.status !== C.PROCESSING_REVERT_ERROR
      );
    ...
    const M = F();
    return g.length ? g.map((w) => Ee(w) ? M[w] ? M[w].id : null : w).filter((w) => w).map((w) => h(w, y)) : Promise.all(M.map((w) => h(w, y)));
  }, U = {
    // supports events
    ...Qe(),
     ...
     */
    insertBefore: (I) => wt(f.element, I),
    /**
     * Inserts the plugin after the target element
     */
    insertAfter: (I) => Gt(f.element, I),
    /**
     ...
     */
    replaceElement: (I) => {
      wt(f.element, I), I.parentNode.removeChild(I), t = I;
    },
    /**
     * Restores the original element
     */
    restoreElement: () => {
      t && (Gt(t, f.element), f.element.parentNode.removeChild(f.element), t = null);
    },
    /**
...
}, jo = (e) => e.charAt(0).toLowerCase() + e.slice(1), Ko = (e) => sr(e.replace(/^data-/, "")), lr = (e, t) => {
  V(t, (n, r) => {
    V(e, (s, o) => {
  ...
  const r = n.filter((s) => s.name).reduce((s, o) => {
    const i = W(e, o.name);
    return s[Ko(o.name)] = i === o.name ? !0 : i, s;
  }, {});
  return lr(r, t), r;
}, Jo = (e, t = {}) => {
  const n = {
...
}, el = (...e) => dr(e[0]) ? Jo(...e) : or(...e), tl = ["fire", "_read", "_write"], En = (e) => {
  const t = {};
  return Pn(e, t, tl), t;
}, nl = (e, t) => e.replace(/(?:{([a-zA-Z]+)})/g, (n, r) => t[r]), rl = (e) => {
  ...
  is(t.options);
}, ll = () => Object.prototype.toString.call(window.operamini) === "[object OperaMini]", al = () => "Promise" in window, cl = () => "slice" in Blob.prototype, dl = () => "URL" in window && "createObjectURL" in window.URL, ul = () => "visibilityState" in document, fl = () => "performance" in window, El = () => "supports" in (window.CSS || {}), pl = () => /MSIE|Trident/.test(window.navigator.userAgent), In = (() => {
  const e = (
    // Has to be a browser
    On() && // Can't run on Opera Mini due to lack of everything
    !ll() && // Require these APIs to feature detect a modern browser
    ul() && al() && cl() && dl() && fl() && // doesn't need CSSSupports but is a good way to detect Safari 9+ (we do want to support IE11 though)
    (El() || pl())
  );
  return () => e;
})(), ue = {
...
let _l = {}, Tl = {}, ml = {}, _n = {}, it = he, ot = he, Tn = he, mn = he, gn = he, Rn = he, hn = he;
if (In()) {
  Fr(
    () => {
  ...
  _l = { ...Nn }, ml = { ...$ }, Tl = { ...C }, _n = {}, t(), it = (...n) => {
    const r = el(...n);
    return r.on("destroy", ot), ue.apps.push(r), En(r);
  }, ot = (n) => {
    const r = ue.apps.findIndex((s) => s.isAttachedTo(n));
    return r >= 0 ? (ue.apps.splice(r, 1)[0].restoreElement(), !0) : !1;
  }, Tn = (n) => Array.from(n.querySelectorAll(`.${Il}`)).filter(
